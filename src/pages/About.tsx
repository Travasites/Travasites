...
import { Target, Lightbulb, Wrench, ArrowRight, CheckCircle2 } from "lucide-react";
...
const values = [
  {
    icon: Target,
    title: "Mission",
    description: "To empower businesses with cutting-edge web solutions and AI tools that drive growth and innovation."
  },
  {
    icon: Lightbulb,
    title: "Vision",
    description: "A world where every business can harness the power of modern technology to achieve their goals."
  },
  {
    icon: Wrench,
    title: "Approach",
    description: "We combine technical excellence with creative problem-solving to deliver solutions that exceed expectations."
  }
];
...
const stack = [
  ...
  "OpenAI", "TailwindCSS", "Vercel", "AWS", "Docker", "GraphQL"
];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl font-bold mb-6">
              About <span className="text-gradient">Blue Forge</span>
            </motion.h1>
            <motion.p variants={fadeInUp} className="text-lg text-muted-foreground">
              A web development studio and AI builder platform dedicated to crafting exceptional digital experiences
            </motion.p>
          </motion.div>
        </div>
      </section>
