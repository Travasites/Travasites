        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl font-bold mb-6">
              Our <span className="text-forge-gradient">Products</span>
            </motion.h1>
          ...
          >
            {products.map((product, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                className="p-8 rounded-2xl bg-forge-steel border border-forge-ember/20 hover:border-forge-orange/40 transition-all group"
              >
                <div className="grid lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-14 h-14 rounded-xl bg-forge-accent flex items-center justify-center shadow-forge">
                        <product.icon className="w-7 h-7 text-forge-orange" />
                      </div>
                      <div>
                        <span className="text-xs font-medium text-forge-orange uppercase tracking-wider">{product.category}</span>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {product.features.map((feature, i) => (
                        <span key={i} className="px-3 py-1 rounded-full bg-forge-iron/50 border border-forge-ember/20 text-sm">
                          {feature}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="flex items-center justify-end">
                    <Button asChild className="bg-forge-accent text-white hover:shadow-forge">
